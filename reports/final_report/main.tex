...
\begin{table}[htbp]
    ...
    \small{\textit{*SFT (Gen): Unsloth Generative Fine-tuning, SFT (Discrim): HuggingFace Classification Head. N/A indicate no Fine-Tuning. Qwen3:8b is not included as it is not available on HuggingFace or Unsloth}}
\end{table}
